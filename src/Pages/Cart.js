...
const Cart = () => {
    ...
    return (
      <div className="flex items-center justify-center my-52">
        <div>
          ...
          <h1 className="text-4xl text-center font-[Poppins] my-6">
            Your cart is empty
          </h1>
        </div>
      </div>
  ...
  const totalCost =
    parseInt(targetRoom?.rentFee) * parseInt(totalDays) * parseInt(quantity);
  ...
  return (
    <div className="font-[Poppins] min-h-screen">
      <h3 className="lg:text-3xl text-2xl text-center my-5 font-bold">
        Vacation Rental, Dhaka
      </h3>
      ...
      <div className="overflow-x-auto w-11/12 mx-auto">
        <table className="table w-full flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-5">
          <thead className="">
          ...
          <tbody className="flex-1 sm:flex-none text-center">
            <tr className="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
              ...
              <td className="border-grey-light border hover:bg-gray-100 p-3">
                ${totalDays > 0 ? totalCost : totalCostDayZero}
              </td>
              <td
                onClick={hanleDeleteBooking}
                className="border-grey-light border hover:bg-gray-100 p-3 text-red-600 hover:text-red-700 hover:font-medium cursor-pointer"
              >
                Delete
              </td>
            </tr>
        ...
        <div className="flex justify-center mb-5">
          <button
            ...
            className="bg-primary px-3 text-white font-[poppins] py-2 rounded lg:ml-8 hover:border border-primary hover:bg-transparent hover:text-primary duration-500"
          >
            Proceed Booking
          </button>
        </div>
