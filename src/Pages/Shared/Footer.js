    ...
    return (
        <div className='font-[Poppins]'>
                ...
                <div>
                    ...
                    <div className="form-control w-80">
                        ...
                        <div className="relative">
                            <input type="text" placeholder="username@abc.com" className="input input-bordered w-full pr-16 text-black" />
                            <button className="btn btn-secondary text-white absolute top-0 right-0 rounded-l-none">Subscribe</button>
                        </div>
                    </div>
                </div>
            </footer>
            <footer className="footer footer-center p-4 bg-neutral text-white">
                <div>
                    <p className='lg:text-base select-none'>Copyright © {year} - All right reserved by <span>
