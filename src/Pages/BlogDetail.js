        ...
        <div className='font-[Poppins] lg:w-full w-96'>
            <div className='pb-10'>
                <div className='flex justify-center my-3 mb-10 w-96 lg:w-full py-2'>
                    <img className='rounded ml-2' src={blogdetail?.image} alt="" />
                </div>
                <div className='my-4 lg:flex grid grid-cols-2 justify-center gap-4 text-center lg:mx-14'>
                    ...
                    <div>
                        ...
                        <span className='lg:text-lg ml-2'>{blogdetail?.date}</span>
                    </div>
                    <span className='lg:text-lg text-base'>Author : Abu Jakaria<small className='lg:inline hidden'> ({blogdetail?.role})</small></span>
                ...
                <div>
                    <h1 className='lg:text-3xl text-2xl text-center my-7 font-semibold'>{blogdetail?.title}</h1>
                    <p className='text-base text-justify lg:mx-12 mx-6'>{blogdetail?.post}</p>
                </div>
            </div>
        </div>
    );
