...
const Register = () => {
  ...
  const handleImageUpload = async (e) => {
    ...
    reader.onloadend = async () => {
      ...
      try {
        ...
        if (!res.ok) throw new Error(d.error?.message || d.error || "Upload failed");
  ...
  const onSubmit = async (data) => {
    ...
    fetch(`${import.meta.env.VITE_ENDPOINT}/signup`, {
      method: "POST",
      headers: {
    ...
    <div className="font-[Poppins] bg-accent flex justify-center">
      <div className="card bg-base-100 lg:w-5/12 lg:shadow-md lg:rounded-md rounded-none lg:my-4 my-3 mb-8 lg:mb-6 lg:py-4">
        <div className="card-body">
          ...
          <h1 className="text-center font-semibold text-primary text-xl my-2">{(error || upError)?.message}</h1>
            ...
            <div>
              ...
              <div className="mb-2 lg:w-9/12 mx-auto">
                <label className="block mb-1" htmlFor="image">
                  Profile Image <span className="text-sm text-gray-500">(Optional)</span>
                </label>
                <div className="flex items-center gap-3">
                  <input
                    ...
                    className="file-input file-input-bordered w-full max-w-lg shrink"
                  />
                  {uploadingImage && <span className="loading loading-spinner text-primary"></span>}
                </div>
                {imageUrl && !uploadingImage && (
                  <div className="avatar mt-3">
                    <div className="w-16 rounded-xl border border-base-200">
              ...
              <div className="lg:mt-3 mt-2 text-center">
                <button
                  type="submit"
                  disabled={loading || updating || uploadingImage}
