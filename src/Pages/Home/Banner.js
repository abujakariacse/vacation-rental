            ...
            <div className="min-h-screen font-[Poppins]">
                <Parallax bgClassName='parallax-image' bgImage={BgImage} strength={400}>
                    <div className='banner-gradient'>
                        <div className='min-h-screen grid md:grid-cols-2 grid-cols-1 items-center justify-items-end md:mx-16 font-serif'>
                            ...
                            <div className="card md:w-96 mx-auto md:mx-0 bg-base-100 shadow-xl rounded-md w-80 my-10 md:my-0 min-h-fit">
