          ...
          <div className="banner-gradient">
            <div className="min-h-screen grid lg:grid-cols-2 grid-cols-1 items-center justify-items-end lg:mx-28 font-serif">
              <div className="my-10 lg:my-0 mx-auto mt-28 lg:mt-0">
                ...
                <h1 className="lg:text-6xl text-3xl font-semibold my-5 text-white">
                  Rent an appartment
                </h1>
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit} className="my-4">
                    <input
                      ...
                      className="input w-full max-w-xs bg-accent placeholder-black text-base my-2"
                      required
                    />
                    ...
                    <div className="grid grid-cols-2 gap-5 my-2">
                      <input
                        ...
                        name="phone"
                        placeholder="Phone"
                        className="input w-full max-w-xs bg-accent placeholder-black text-base"
                        required
                      />
                      <input
                        type="time"
