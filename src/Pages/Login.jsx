...
const Login = () => {
  ...
  useEffect(() => {
    if (!(user || gUser || gitUser || fUser)) return;

    navigate("/", { replace: true });
    toast.success("Signed in successfully");
  }, [user, gUser, gitUser, fUser, navigate]);
  return (
        ...
        <div className="card-body">
          ...
          <div className="flex justify-center mb-4">
            <button
                type="button"
                onClick={() => {
                  setValue("email", "admin@vr.com");
                  setValue("password", "admin123");
                }}
                className="btn btn-outline btn-sm text-primary border-primary flex items-center gap-2"
              >
              <i className="fa-solid fa-user-shield"></i> Demo Admin
            </button>
          </div>
          <span
            className={`${
