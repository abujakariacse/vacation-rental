        ...
        <div className='font-[Poppins] bg-accent flex justify-center'>
            <div className="card bg-base-100 lg:w-5/12 lg:shadow-md lg:rounded-md rounded-none lg:my-4 my-3 mb-8 lg:mb-6 lg:py-4">
                <div className="card-body">
                    <h1 className='lg:text-3xl text-2xl font-bold mb-4 text-center'>Create a new account</h1>
                    <form onSubmit={handleSubmit(onSubmit)}>
                        <div>
                            <div className='mb-2 lg:w-9/12 mx-auto'>
                                ...
                                <div>
                                    <input
                                        ...
                                        type="text" name='name' placeholder="Your Name" className="input input-bordered w-full max-w-lg focus:outline-none focus:border-2 text-base input-field" />
                            ...
                            <div className='mb-2 lg:w-9/12 mx-auto'>
                                <label className='block mb-1' htmlFor="email">Date of Birth</label>
                                <div>
                                    <input
                                        {...register("DOB", {
                                            required: {
                                        ...
                                        type="date" className="input input-bordered w-full max-w-lg focus:outline-none focus:border-2 text-base email-field" />
                                    <label className="label">
                                        {errors.DOB?.type === 'required' && <span className="text-sm text-red-500">{errors.DOB.message}</span>}
                                    </label>
                                </div>
                            </div>
                            <div>
                                <div className='mb-2 lg:w-9/12 mx-auto'>
                                    ...
                                    <div className='input-group relative'>
                                        <input
                                            ...
                                            type='text' name='password' placeholder="Your password" className="input input-bordered w-full max-w-lg focus:outline-none focus:border-2 text-base  password-field" />
                                    </div>
                                    <label className="label">
                            ...
                            <div className='lg:mt-3 mt-2 text-center'>
                                <input className='btn lg:w-9/12 w-full btn-primary text-base normal-case text-white' type="submit" value="Sign Up" />
                            </div>
                        </div>
                    </form>
                    <div>
                        <div>
                            <h2 className='text-center mt-3 lg:text-base text-lg'>Already have an account? <span className='font-semibold text-primary lg:inline block text-lg'><Link to='/login'>Sign In</Link></span></h2>
                        </div>
                    </div>
                </div>
